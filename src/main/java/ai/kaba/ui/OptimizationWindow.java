...
public class OptimizationWindow extends AbstractGraphWindow {
	 ...
	 */
	private static final long serialVersionUID = -2233179315020771699L;
    ...
    protected void initRadioButtons() {
        ...
        JRadioButton geneticAlgorithm = new JRadioButton("Genetic Algorithm");
        tabuSearch.setMnemonic(KeyEvent.VK_G);
